...
SECRET_KEY = 'django-insecure-i@j31*14f_+hjyvf5u%^(m5em#e#42kehrkvn@smr7*(=%g^r%'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

# ALLOWED_HOSTS = ['localhost', '127.0.0.1', '192.168.150.2','192.168.169.39']
...
TEMPLATES = [
    {
        ...
        "DIRS": [BASE_DIR / "templates"],   #this one was an error that solved: this direction for templates was empty that we have to fill it. 
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
